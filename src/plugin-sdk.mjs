...
export const PluginEvents = Object.freeze({
  ...
  CORE_AFTER_OPERATION: 'core:after-operation'
})
...
const typedRequest = (context, method, args) => createRequest(context)(method, args)

export const page = Object.freeze({
  read: (context, field) => typedRequest(context, 'page.read', { field }),
  write: (context, field, value) => typedRequest(context, 'page.write', { field, value })
})

export const window = Object.freeze({
  create: (context, options = {}) => typedRequest(context, 'window.create', options),
  close: (context, windowId) => typedRequest(context, 'window.close', { windowId })
})

export const files = Object.freeze({
  read: (context, args = {}) => typedRequest(context, 'files.read', args),
  write: (context, args = {}) => typedRequest(context, 'files.write', args)
})

export const net = Object.freeze({
  request: (context, args = {}) => typedRequest(context, 'net.request', args)
})

export const state = Object.freeze({
  read: (context, key) => typedRequest(context, 'state.read', { key }),
  write: (context, key, value) => typedRequest(context, 'state.write', { key, value })
})

export const dom = Object.freeze({
  query: (context, args = {}) => typedRequest(context, 'dom.query', args),
  read: (context, args = {}) => typedRequest(context, 'dom.read', args),
  write: (context, args = {}) => typedRequest(context, 'dom.write', args),
  insert: (context, args = {}) => typedRequest(context, 'dom.insert', args)
})

export const core = Object.freeze({
  names: Object.freeze({ read: context => typedRequest(context, 'core.names.read', {}) }),
  records: Object.freeze({ read: context => typedRequest(context, 'core.records.read', {}) }),
  statistics: Object.freeze({ read: context => typedRequest(context, 'core.statistics.read', {}) }),
  hook: Object.freeze({
    before: (context, operation, input = {}) => typedRequest(context, 'core.hook.before', { operation, input }),
    after: (context, operation, event = {}) => typedRequest(context, 'core.hook.after', { operation, event })
  }),
  'names.read': context => typedRequest(context, 'core.names.read', {}),
  'records.read': context => typedRequest(context, 'core.records.read', {}),
  'statistics.read': context => typedRequest(context, 'core.statistics.read', {}),
  'hook.before': (context, operation, input = {}) => typedRequest(context, 'core.hook.before', { operation, input }),
  'hook.after': (context, operation, event = {}) => typedRequest(context, 'core.hook.after', { operation, event })
})
