...
export declare const PluginEvents: {
  ...
  readonly CORE_BEFORE_OPERATION: 'core:before-operation'
  readonly CORE_AFTER_OPERATION: 'core:after-operation'
}
...
export interface PluginRequestResult<T = unknown> {
  ok: boolean
  value?: T | null
  code?: string
  message?: string
...
export declare const page: { read(context: PluginContext, field: string): Promise<PluginRequestResult>; write(context: PluginContext, field: string, value: unknown): Promise<PluginRequestResult> }
export declare const window: { create(context: PluginContext, options?: Record<string, unknown>): Promise<PluginRequestResult>; close(context: PluginContext, windowId: string): Promise<PluginRequestResult> }
export declare const files: { read(context: PluginContext, args?: Record<string, unknown>): Promise<PluginRequestResult>; write(context: PluginContext, args?: Record<string, unknown>): Promise<PluginRequestResult> }
export declare const net: { request(context: PluginContext, args?: Record<string, unknown>): Promise<PluginRequestResult> }
export declare const state: { read(context: PluginContext, key: string): Promise<PluginRequestResult>; write(context: PluginContext, key: string, value: unknown): Promise<PluginRequestResult> }
export declare const core: {
  names: { read(context: PluginContext): Promise<PluginRequestResult> }
  records: { read(context: PluginContext): Promise<PluginRequestResult> }
  statistics: { read(context: PluginContext): Promise<PluginRequestResult> }
  hook: { before(context: PluginContext, operation: string, input?: Record<string, unknown>): Promise<PluginRequestResult>; after(context: PluginContext, operation: string, event?: Record<string, unknown>): Promise<PluginRequestResult> }
}
